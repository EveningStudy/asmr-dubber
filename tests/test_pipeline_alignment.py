...
def test_single_asr_can_run_qwen_forced_alignment_without_multi_asr(
    ...
    def fake_transcribe(_audio, _settings, progress=None):
        return (
            [
                Sentence(
                    id="s000001",
    ...
    def fake_align(audio, sentences, settings, progress=None):
    ...
    monkeypatch.setattr(pipeline, "transcribe_japanese", fake_transcribe)
