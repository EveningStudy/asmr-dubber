...
| 设置 | 默认 | 作用 |
|---|---:|---|
| 中文配音整体偏移 | 0 ms | 相对原字幕开始时间统一移动；负数提前，正数延后 |
| 冲突时最大自动加速倍速 | 1.2× | 当前句超过下一条有效中文配音的开始时间时使用 |
...
“保留中文中间轨”用于后期制作，会增加磁盘占用。“跳过纯日语语气词”会避免为没有实义的
短语气词合成中文。“参考音频边缘扩展”给逐句参考前后增加少量上下文。
